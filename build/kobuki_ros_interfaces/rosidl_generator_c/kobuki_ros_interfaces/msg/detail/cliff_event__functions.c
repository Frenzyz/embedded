...
kobuki_ros_interfaces__msg__CliffEvent__create(void)
{
  ...
  kobuki_ros_interfaces__msg__CliffEvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__msg__CliffEvent * data =
      (kobuki_ros_interfaces__msg__CliffEvent *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__msg__CliffEvent__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__msg__CliffEvent__fini(&output->data[i]);
        }
        return false;
      }
    }
