...
// IWYU pragma: private, include "kobuki_ros_interfaces/msg/led.h"


#ifndef KOBUKI_ROS_INTERFACES__MSG__DETAIL__LED__FUNCTIONS_H_
#define KOBUKI_ROS_INTERFACES__MSG__DETAIL__LED__FUNCTIONS_H_
 ...
 * calls
 * kobuki_ros_interfaces__msg__Led__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kobuki_ros_interfaces
kobuki_ros_interfaces__msg__Led *
kobuki_ros_interfaces__msg__Led__create(void);

/// Destroy msg/Led message.
/**
 * It calls
 * kobuki_ros_interfaces__msg__Led__fini()
 ...
 * kobuki_ros_interfaces__msg__Led__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * kobuki_ros_interfaces__msg__Led__Sequence__fini()
 * on the array,
...
#endif  // KOBUKI_ROS_INTERFACES__MSG__DETAIL__LED__FUNCTIONS_H_
