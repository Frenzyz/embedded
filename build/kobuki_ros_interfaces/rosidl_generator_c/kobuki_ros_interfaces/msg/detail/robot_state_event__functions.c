...
kobuki_ros_interfaces__msg__RobotStateEvent__create(void)
{
  ...
  kobuki_ros_interfaces__msg__RobotStateEvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kobuki_ros_interfaces__msg__RobotStateEvent * data =
      (kobuki_ros_interfaces__msg__RobotStateEvent *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kobuki_ros_interfaces__msg__RobotStateEvent__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          kobuki_ros_interfaces__msg__RobotStateEvent__fini(&output->data[i]);
        }
        return false;
      }
    }
