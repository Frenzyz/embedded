...
class Init_AutoDocking_SendGoal_Event_response
{
public:
  explicit Init_AutoDocking_SendGoal_Event_response(::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event response(::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event::_response_type arg)
  {
...
private:
  ::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event msg_;
};

class Init_AutoDocking_SendGoal_Event_request
{
public:
  explicit Init_AutoDocking_SendGoal_Event_request(::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_AutoDocking_SendGoal_Event_response request(::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_AutoDocking_SendGoal_Event_response(msg_);
  }
...
class Init_AutoDocking_SendGoal_Event_info
{
public:
  Init_AutoDocking_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AutoDocking_SendGoal_Event_request info(::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_AutoDocking_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::kobuki_ros_interfaces::action::AutoDocking_SendGoal_Event>()
{
  return kobuki_ros_interfaces::action::builder::Init_AutoDocking_SendGoal_Event_info();
}
...
class Init_AutoDocking_GetResult_Event_response
{
public:
  explicit Init_AutoDocking_GetResult_Event_response(::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event response(::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event msg_;
};

class Init_AutoDocking_GetResult_Event_request
{
public:
  explicit Init_AutoDocking_GetResult_Event_request(::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_AutoDocking_GetResult_Event_response request(::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_AutoDocking_GetResult_Event_response(msg_);
  }
...
class Init_AutoDocking_GetResult_Event_info
{
public:
  Init_AutoDocking_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AutoDocking_GetResult_Event_request info(::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_AutoDocking_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::kobuki_ros_interfaces::action::AutoDocking_GetResult_Event>()
{
  return kobuki_ros_interfaces::action::builder::Init_AutoDocking_GetResult_Event_info();
}
