...
// IWYU pragma: private, include "kobuki_ros_interfaces/msg/motor_power.hpp"
...
inline std::string to_yaml(const MotorPower & msg, bool use_flow_style = false)
{
