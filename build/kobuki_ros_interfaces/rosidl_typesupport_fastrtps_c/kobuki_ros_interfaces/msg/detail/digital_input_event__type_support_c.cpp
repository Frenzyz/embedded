...
bool cdr_serialize_kobuki_ros_interfaces__msg__DigitalInputEvent(
  const kobuki_ros_interfaces__msg__DigitalInputEvent * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
bool cdr_deserialize_kobuki_ros_interfaces__msg__DigitalInputEvent(
  eprosima::fastcdr::Cdr & cdr,
  kobuki_ros_interfaces__msg__DigitalInputEvent * ros_message)
{
  // Field name: values
  {
    size_t size = 4;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
bool cdr_serialize_key_kobuki_ros_interfaces__msg__DigitalInputEvent(
  const kobuki_ros_interfaces__msg__DigitalInputEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: values
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t get_serialized_size_key_kobuki_ros_interfaces__msg__DigitalInputEvent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DigitalInputEvent__ros_msg_type * ros_message = static_cast<const _DigitalInputEvent__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t max_serialized_size_key_kobuki_ros_interfaces__msg__DigitalInputEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const kobuki_ros_interfaces__msg__DigitalInputEvent * ros_message = static_cast<const kobuki_ros_interfaces__msg__DigitalInputEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_kobuki_ros_interfaces__msg__DigitalInputEvent(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  kobuki_ros_interfaces__msg__DigitalInputEvent * ros_message = static_cast<kobuki_ros_interfaces__msg__DigitalInputEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_kobuki_ros_interfaces__msg__DigitalInputEvent(cdr, ros_message);
}
