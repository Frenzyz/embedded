...
bool cdr_serialize_kobuki_ros_interfaces__msg__VersionInfo(
  const kobuki_ros_interfaces__msg__VersionInfo * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
bool cdr_deserialize_kobuki_ros_interfaces__msg__VersionInfo(
  eprosima::fastcdr::Cdr & cdr,
  kobuki_ros_interfaces__msg__VersionInfo * ros_message)
{
  // Field name: hardware
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
bool cdr_serialize_key_kobuki_ros_interfaces__msg__VersionInfo(
  const kobuki_ros_interfaces__msg__VersionInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: hardware
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t get_serialized_size_key_kobuki_ros_interfaces__msg__VersionInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VersionInfo__ros_msg_type * ros_message = static_cast<const _VersionInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t max_serialized_size_key_kobuki_ros_interfaces__msg__VersionInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const kobuki_ros_interfaces__msg__VersionInfo * ros_message = static_cast<const kobuki_ros_interfaces__msg__VersionInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_kobuki_ros_interfaces__msg__VersionInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  kobuki_ros_interfaces__msg__VersionInfo * ros_message = static_cast<kobuki_ros_interfaces__msg__VersionInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_kobuki_ros_interfaces__msg__VersionInfo(cdr, ros_message);
}
