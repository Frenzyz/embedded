...
bool cdr_serialize_kobuki_ros_interfaces__msg__WheelDropEvent(
  const kobuki_ros_interfaces__msg__WheelDropEvent * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
bool cdr_deserialize_kobuki_ros_interfaces__msg__WheelDropEvent(
  eprosima::fastcdr::Cdr & cdr,
  kobuki_ros_interfaces__msg__WheelDropEvent * ros_message)
{
  // Field name: wheel
  {
    cdr >> ros_message->wheel;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
bool cdr_serialize_key_kobuki_ros_interfaces__msg__WheelDropEvent(
  const kobuki_ros_interfaces__msg__WheelDropEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: wheel
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t get_serialized_size_key_kobuki_ros_interfaces__msg__WheelDropEvent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WheelDropEvent__ros_msg_type * ros_message = static_cast<const _WheelDropEvent__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kobuki_ros_interfaces
size_t max_serialized_size_key_kobuki_ros_interfaces__msg__WheelDropEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const kobuki_ros_interfaces__msg__WheelDropEvent * ros_message = static_cast<const kobuki_ros_interfaces__msg__WheelDropEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_kobuki_ros_interfaces__msg__WheelDropEvent(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  kobuki_ros_interfaces__msg__WheelDropEvent * ros_message = static_cast<kobuki_ros_interfaces__msg__WheelDropEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_kobuki_ros_interfaces__msg__WheelDropEvent(cdr, ros_message);
}
